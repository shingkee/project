...
/* @groups/groups.twig */
class __TwigTemplate_b194e4edf2b5f94a4126fbf84aa6ae0931b605985336f8cc788bbd82ddebc90d extends Twig_Template
{
...
\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["type"] => $context["count"]) {
            ...
            if (($context["count"] > 0)) {
                ...
                echo "\">";
                echo twig_escape_filter($this->env, $this->getAttribute((isset($context["groupsSectionTitles"]) ? $context["groupsSectionTitles"] : null), $context["type"], array(), "array"), "html", null, true);
...
\t\t\t\t";
        // line 28
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(twig_array_merge(array(0 => "all"), twig_get_array_keys_filter((isset($context["counts"]) ? $context["counts"] : null))));
        $context['loop'] = array(
...
\t\t\t\t\t\t\t";
            ...
            if (($context["section"] == "invited")) {
                // line 38
                echo "\t\t\t\t\t\t\t   \t";
                $this->loadTemplate("@groups/groups.twig", "@groups/groups.twig", 38, "638193060")->display(array_merge($context, array("groups" => $this->getAttribute((isset($context["groups"]) ? $context["groups"] : null), $context["section"], array(), "array"))));
                // line 50
                echo "\t\t\t\t\t\t\t";
            } else {
                // line 51
                echo "\t\t\t\t\t\t\t\t ";
                $this->loadTemplate("@groups/partials/groups-list.twig", "@groups/groups.twig", 51)->display(array_merge($context, array("groups" => $this->getAttribute((isset($context["groups"]) ? $context["groups"] : null), $context["section"], array(), "array"))));
                // line 52
                echo "\t\t\t\t\t\t\t";
            }
            // line 53
...
";
    ...
    {
        return new Twig_Source("", "@groups/groups.twig", "/Users/shingkeelau/web/wp-content/plugins/membership-by-supsystic/src/Membership/Groups/views/groups.twig");
    }
}


/* @groups/groups.twig */
class __TwigTemplate_b194e4edf2b5f94a4126fbf84aa6ae0931b605985336f8cc788bbd82ddebc90d_638193060 extends Twig_Template
{
    public function __construct(Twig_Environment $env)
    {
        parent::__construct($env);
    ...
    public function block_actionButtons($context, array $blocks = array())
    {
        // line 40
        echo "\t\t\t\t\t\t\t\t\t\t";
        if ( !$this->env->getExtension('Membership_Groups_Twig')->isMemberOfGroup((isset($context["group"]) ? $context["group"] : null))) {
            // line 41
