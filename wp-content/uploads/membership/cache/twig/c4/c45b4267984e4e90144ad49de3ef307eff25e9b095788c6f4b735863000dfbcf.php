...
class __TwigTemplate_41bcf7551dfd58fcb1edb844b33ac3d76286d25dca99f0b52a5bf4db39795e80 extends Twig_Template
{
...
\t";
        // line 2
        if ((isset($context["contactFormPresets"]) ? $context["contactFormPresets"] : null)) {
            // line 3
            echo "\t<div class=\"row\">
\t\t<div class=\"col-md-4\">
...
\t\t\t\t<div class=\"mp-option-button mp-opt-contact-form-btn\" ";
            // line 11
            if ($this->getAttribute((isset($context["pagesInfo"]) ? $context["pagesInfo"] : null), "contact_form", array())) {
...
\t\t\t\t\t";
            // line 18
            echo $this->env->getExtension('Membership_Base_Twig')->callFunction("wp_dropdown_pages", array("name" => "pages[contact_form]", "selected" => $this->getAttribute((isset($context["pagesInfo"]) ? $context["pagesInfo"] : null), "contact_form", array()), "class" => "sc-input wp-pages-list", "echo" => false, "show_option_none" => "Select Page", "option_none_value" => "__none"));
            echo "
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
...
\t\t\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["contactFormPresets"]) ? $context["contactFormPresets"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["val1"]) {
                ...
                echo "\" ";
                if (($this->getAttribute((isset($context["pagesInfo"]) ? $context["pagesInfo"] : null), "contact_form_preset", array()) == $this->getAttribute($context["val1"], "id", array()))) {
...
(isset($context["isPluginActive"]) ? $context["isPluginActive"] : null) == true)) {
            // line 49
            echo "\t<div class=\"row\">
\t\t<div class=\"col-md-4\">
\t\t\t<div class=\"mp-option-label\">
...
\t\t\t\t<a target=\"_blank\" href=\"";
            // line 71
            echo twig_escape_filter($this->env, (isset($context["pluginInstallUrl"]) ? $context["pluginInstallUrl"] : null), "html", null, true);
            echo "\">";
...
\t\t\t\t<a target=\"_blank\" href=\"";
            // line 73
            echo twig_escape_filter($this->env, (isset($context["wpPluginInstallUrl"]) ? $context["wpPluginInstallUrl"] : null), "html", null, true);
            echo "\">";
...
";
    ...
    {
        return new Twig_Source("", "@contactform/partials/backend.main.page.contact.form.twig", "/Users/shingkeelau/web/wp-content/plugins/membership-by-supsystic/src/Membership/ContactForm/views/partials/backend.main.page.contact.form.twig");
    }
}
