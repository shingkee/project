...
class __TwigTemplate_43eca5dccd31feee7281ff77a2b8f9bc4d1ad4874b04fc626304398a6ba06263 extends Twig_Template
{
...
($context["settings"] ?? null), "general", array()), "avatar-style", array(), "array") == "round")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Circle")), "name" => "general[avatar-style]", "value" => "circle", "checked" => ($this->getAttribute($this->getAttribute(        // line 61
($context["settings"] ?? null), "general", array()), "avatar-style", array(), "array") == "circle")), 2 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Square")), "name" => "general[avatar-style]", "value" => "square", "checked" => ($this->getAttribute($this->getAttribute(        // line 67
($context["settings"] ?? null), "general", array()), "avatar-style", array(), "array") == "square"))), "avatar-style");
        // line 70
        echo "
...
($context["settings"] ?? null), "general", array()), "default-theme-colors", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "general[default-theme-colors]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 83
($context["settings"] ?? null), "general", array()), "default-theme-colors", array(), "array") == "false"))), "default-theme-colors");
        // line 86
        echo "
...
($context["settings"] ?? null), "general", array()), "primary-button-color", array(), "array"), "primary-button-color");
        // line 94
        echo "
...
($context["settings"] ?? null), "general", array()), "primary-button-hover-color", array(), "array"), "primary-button-hover-color");
        // line 100
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "general", array()), "secondary-button-color", array(), "array"), "secondary-button-color");
        // line 106
        echo "
...
($context["settings"] ?? null), "general", array()), "secondary-button-hover-color", array(), "array"), "secondary-button-hover-color");
        // line 112
        echo "
...
($context["settings"] ?? null), "general", array(), "any", false, true), "smile-button-bg-color", array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "general", array(), "any", false, true), "smile-button-bg-color", array(), "array"), "#fff")) : ("#fff")), "smile-button-bg-color");
        // line 118
        echo "
...
($context["settings"] ?? null), "general", array(), "any", false, true), "smile-button-hover-bg-color", array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "general", array(), "any", false, true), "smile-button-hover-bg-color", array(), "array"), "#fff")) : ("#fff")), "smile-button-hover-bg-color");
        // line 124
        echo "
...
($context["settings"] ?? null), "general", array()), "primary-color", array(), "array"), "primary-color");
        // line 152
        echo "
...
($context["settings"] ?? null), "general", array()), "secondary-color", array(), "array"), "secondary-color");
        // line 158
        echo " -->
...
($context["settings"] ?? null), "general", array()), "input-border-color", array(), "array"), "input-border-color");
        // line 166
        echo "
...
($context["settings"] ?? null), "general", array()), "input-border-focus-color", array(), "array"), "input-border-focus-color");
        // line 172
        echo "
...
($context["settings"] ?? null), "general", array()), "input-background-color", array(), "array"), "input-background-color");
        // line 178
        echo "
...
($context["settings"] ?? null), "general", array()), "input-background-focus-color", array(), "array"), "input-background-focus-color");
        // line 184
        echo "
...
($context["settings"] ?? null), "general", array()), "input-placeholder-color", array(), "array"), "input-placeholder-color");
        // line 190
        echo "
...
($context["settings"] ?? null), "general", array()), "help-icon-background-color", array(), "array"), "help-icon-background-color");
        // line 196
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "general", array()), "help-icon-text-color", array(), "array"), "help-icon-text-color");
        // line 202
        echo "
...
($context["settings"] ?? null), "general", array()), "css_visibility_asterisk", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "general[css_visibility_asterisk]", "value" => "hidden", "checked" => ($this->getAttribute($this->getAttribute(        // line 215
($context["settings"] ?? null), "general", array()), "css_visibility_asterisk", array(), "array") == "false"))), "show-asterisk");
        // line 218
        echo "
...
($context["settings"] ?? null), "general", array()), "css_color_asterisk", array(), "array"), "asterisk-color", ((($this->getAttribute($this->getAttribute(        // line 224
...
($context["settings"] ?? null), "menu", array()), "add-logout-link", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "menu[add-logout-link]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 250
($context["settings"] ?? null), "menu", array()), "add-logout-link", array(), "array") == "false"))), "add-logout-link");
        // line 253
        echo "
...
($context["wpMenuList"] ?? null), $this->getAttribute($this->getAttribute(        // line 260
...
($context["settings"] ?? null), "menu", array()), "remove-login-registration", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "menu[remove-login-registration]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 286
($context["settings"] ?? null), "menu", array()), "remove-login-registration", array(), "array") == "false"))), "remove-login-registration");
        // line 289
        echo "
...
($context["settings"] ?? null), "activity", array()), "show-filter", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[show-filter]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 314
($context["settings"] ?? null), "activity", array()), "show-filter", array(), "array") == "false"))), "activity.show-filter");
        // line 317
        echo "
...
($context["settings"] ?? null), "activity", array()), "default-filter", array(), "array") == "subscriptions")), 1 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Popular")), "value" => "popular", "selected" => ($this->getAttribute($this->getAttribute(        // line 328
($context["settings"] ?? null), "activity", array()), "default-filter", array(), "array") == "popular")), 2 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Site wide")), "value" => "site-wide", "selected" => ($this->getAttribute($this->getAttribute(        // line 333
($context["settings"] ?? null), "activity", array()), "default-filter", array(), "array") == "site-wide"))), "activity[default-filter]");
        // line 336
        echo "
\t\t\t\t\t
\t\t\t\t\t<h3>";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "posts", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][posts]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 351
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "posts", array(), "array") == "false"))), "activity.type.posts");
        // line 354
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "photos", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][photos]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 367
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "photos", array(), "array") == "false"))), "activity.type.photos");
        // line 370
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "shares", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][shares]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 383
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "shares", array(), "array") == "false"))), "activity.type.shares");
        // line 386
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "likes", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][likes]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 399
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "likes", array(), "array") == "false"))), "activity.type.likes");
        // line 402
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "comments", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][comments]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 415
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "comments", array(), "array") == "false"))), "activity.type.comments");
        // line 418
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "groups", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][groups]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 431
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "groups", array(), "array") == "false"))), "activity.type.groups");
        // line 434
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "social", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][social]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 447
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "social", array(), "array") == "false"))), "activity.type.social");
        // line 450
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "forum", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "activity[type][forum]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute($this->getAttribute(        // line 463
($context["settings"] ?? null), "activity", array()), "type", array(), "array"), "forum", array(), "array") == "false"))), "activity.type.forum");
        // line 466
        echo "
\t\t\t\t\t
\t\t\t\t</div>
...
($context["settings"] ?? null), "profile", array()), "container-max-width", array(), "array"), "container-max-width");
        // line 482
        echo "
...
($context["settings"] ?? null), "profile", array()), "header-background-color", array(), "array"), "header-background-color");
        // line 488
        echo "
...
($context["settings"] ?? null), "profile", array()), "show-display-name", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "profile[show-display-name]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 502
($context["settings"] ?? null), "profile", array()), "show-display-name", array(), "array") == "false"))), "show-display-name");
        // line 505
        echo "
...
($context["settings"] ?? null), "auth", array()), "registration-primary-button-text", array(), "array"), "registration-primary-button-text");
        // line 525
        echo "
\t\t\t\t\t
\t\t\t\t\t<h3>";
...
($context["settings"] ?? null), "auth", array()), "login-primary-button-text", array(), "array"), "login-primary-button-text");
        // line 533
        echo "
...
($context["settings"] ?? null), "auth", array()), "login-secondary-button", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "auth[login-secondary-button]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 546
($context["settings"] ?? null), "auth", array()), "login-secondary-button", array(), "array") == "false"))), "login-secondary-button");
        // line 549
        echo "
...
($context["settings"] ?? null), "auth", array()), "login-secondary-button-text", array(), "array"), "login-secondary-button-text");
        // line 555
        echo "
...
($context["settings"] ?? null), "auth", array()), "login-secondary-button-url", array(), "array"), "login-secondary-button-url");
        // line 561
        echo "
...
($context["settings"] ?? null), "auth", array()), "login-show-remember-me", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "auth[login-show-remember-me]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 574
($context["settings"] ?? null), "auth", array()), "login-show-remember-me", array(), "array") == "false"))), "login-show-remember-me");
        // line 577
        echo "
\t\t\t\t\t
\t\t\t\t\t
...
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-enable", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "auth[login-google-recaptcha-enable]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 591
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-enable", array(), "array") == "false"))), "login-google-recaptcha-enable");
        // line 594
        echo "
...
($context["settings"] ?? null), "auth", array(), "any", false, true), "login-after-register-enable", array(), "array", true, true) && ($this->getAttribute($this->getAttribute(($context["settings"] ?? null), "auth", array()), "login-after-register-enable", array(), "array") == 0)))), "login-after-register-enable");
        // line 610
        echo "
\t\t\t\t\t
...
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-site-key", array(), "array"), "login-google-recaptcha-site-key");
        // line 618
        echo "
\t\t\t\t\t
\t\t\t\t\t
...
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-secret-key", array(), "array"), "login-google-recaptcha-secret-key");
        // line 625
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-theme", array(), "array") == "light")), 1 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Dark")), "value" => "dark", "selected" => ($this->getAttribute($this->getAttribute(        // line 636
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-theme", array(), "array") == "dark"))), "auth[login-google-recaptcha-theme]", "google-re-captcha-theme");
        // line 640
        echo "
\t\t\t\t\t
\t\t\t\t\t";
...
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-type", array(), "array") == "image")), 1 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Audio")), "value" => "audio", "selected" => ($this->getAttribute($this->getAttribute(        // line 651
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-type", array(), "array") == "audio"))), "auth[login-google-recaptcha-type]", "google-re-captcha-type");
        // line 655
        echo "
\t\t\t\t\t
\t\t\t\t\t
...
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-size", array(), "array") == "normal")), 1 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Compact")), "value" => "compact", "selected" => ($this->getAttribute($this->getAttribute(        // line 667
($context["settings"] ?? null), "auth", array()), "login-google-recaptcha-size", array(), "array") == "compact"))), "auth[login-google-recaptcha-size]", "google-re-captcha-size");
        // line 671
        echo "
\t\t\t\t\t
\t\t\t\t\t</div>
...
\t\t\t\t\t";
        ...
        foreach ($context['_seq'] as $context["value"] => $context["role"]) {
            // line 694
            echo "\t\t\t\t\t\t";
            $context["_roles"] = twig_array_merge(($context["_roles"] ?? null), array(0 => array("title" => $this->getAttribute(            // line 695
...
($context["_roles"] ?? null), "members[roles-to-display]", "roles-to-display");
        // line 705
        echo "
...
($context["settings"] ?? null), "members", array()), "show-only-with-avatar", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-only-with-avatar]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 719
($context["settings"] ?? null), "members", array()), "show-only-with-avatar", array(), "array") == "false"))), "show-only-with-avatar");
        // line 722
        echo "
...
($context["settings"] ?? null), "members", array()), "show-only-with-cover", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-only-with-cover]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 736
($context["settings"] ?? null), "members", array()), "show-only-with-cover", array(), "array") == "false"))), "show-only-with-cover");
        // line 739
        echo "
...
($context["settings"] ?? null), "members", array()), "show-load-more-button", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-load-more-button]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 753
($context["settings"] ?? null), "members", array()), "show-load-more-button", array(), "array") == "false"))), "show-load-more-button");
        // line 756
        echo "
...
($context["settings"] ?? null), "members", array()), "show-pages", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-pages]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 770
($context["settings"] ?? null), "members", array()), "show-pages", array(), "array") == "false"))), "show-pages");
        // line 773
        echo "
...
($context["settings"] ?? null), "members", array()), "sort-users-by", array(), "array") == "new-users-first")), 1 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Old Users First")), "value" => "old-users-first", "selected" => ($this->getAttribute($this->getAttribute(        // line 784
($context["settings"] ?? null), "members", array()), "sort-users-by", array(), "array") == "old-users-first")), 2 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("First Name")), "value" => "first-name", "selected" => ($this->getAttribute($this->getAttribute(        // line 789
($context["settings"] ?? null), "members", array()), "sort-users-by", array(), "array") == "first-name")), 3 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Last Name")), "value" => "last-name", "selected" => ($this->getAttribute($this->getAttribute(        // line 794
($context["settings"] ?? null), "members", array()), "sort-users-by", array(), "array") == "last-name")), 4 => array("title" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Random")), "value" => "random", "selected" => ($this->getAttribute($this->getAttribute(        // line 799
($context["settings"] ?? null), "members", array()), "sort-users-by", array(), "array") == "random"))), "members[sort-users-by]", "sort-users-by");
        // line 803
        echo "
...
($context["settings"] ?? null), "members", array()), "show-friends-and-followers", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-friends-and-followers]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 819
($context["settings"] ?? null), "members", array()), "show-friends-and-followers", array(), "array") == "false"))), "show-display-name");
        // line 822
        echo "
...
($context["settings"] ?? null), "members", array()), "enable-profile-photo", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[enable-profile-photo]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 836
($context["settings"] ?? null), "members", array()), "enable-profile-photo", array(), "array") == "false"))), "enable-profile-cards");
        // line 839
        echo "
...
($context["settings"] ?? null), "members", array()), "enable-cover-photo", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[enable-cover-photo]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 852
($context["settings"] ?? null), "members", array()), "enable-cover-photo", array(), "array") == "false"))), "enable-cover-photo");
        // line 855
        echo "
...
($context["settings"] ?? null), "members", array()), "show-display-name", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-display-name]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 868
($context["settings"] ?? null), "members", array()), "show-display-name", array(), "array") == "false"))), "show-display-name");
        // line 871
        echo "
...
($context["settings"] ?? null), "members", array()), "show-tagline", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-tagline]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 884
($context["settings"] ?? null), "members", array()), "show-tagline", array(), "array") == "false"))), "show-tagline");
        // line 887
        echo "
...
($context["settings"] ?? null), "members", array()), "show-extra-user-information", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-extra-user-information]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 900
($context["settings"] ?? null), "members", array()), "show-extra-user-information", array(), "array") == "false"))), "show-extra-user-information");
        // line 903
        echo "
 -->
<!-- \t\t\t\t\t<h3>Search Option</h3>
...
($context["settings"] ?? null), "members", array()), "enable-search-options", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[enable-search-options]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 918
($context["settings"] ?? null), "members", array()), "enable-search-options", array(), "array") == "false"))), "enable-search-options");
        // line 921
        echo "
...
($context["settings"] ?? null), "members", array()), "show-search-result-after-search", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-search-result-after-search]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 934
($context["settings"] ?? null), "members", array()), "show-search-result-after-search", array(), "array") == "false"))), "show-search-result-after-search");
        // line 937
        echo "
...
($context["settings"] ?? null), "members", array()), "user-role-that-can-use-search", array(), "array") == "none"), "disabled" => true)), "members[user-role-that-can-use-search]", "user-role-that-can-use-search");
        // line 948
        echo "
...
($context["settings"] ?? null), "members", array()), "show-search-result-after-search", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[show-search-result-after-search]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 972
($context["settings"] ?? null), "members", array()), "show-search-result-after-search", array(), "array") == "false"))), "show-search-result-after-search");
        // line 975
        echo "
...
($context["settings"] ?? null), "members", array()), "search-results-text", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[search-results-text]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 989
($context["settings"] ?? null), "members", array()), "search-results-text", array(), "array") == "false"))), "search-results-text");
        // line 992
        echo "
...
($context["settings"] ?? null), "members", array()), "single-search-results-text", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[single-search-results-text]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 1005
($context["settings"] ?? null), "members", array()), "single-search-results-text", array(), "array") == "false"))), "single-search-results-text");
        // line 1008
        echo "
...
($context["settings"] ?? null), "members", array()), "custeom-text-if-no-users-found", array(), "array") == "true")), 1 => array("label" => call_user_func_array($this->env->getFunction('translate')->getCallable(), array("No")), "name" => "members[custeom-text-if-no-users-found]", "value" => "false", "checked" => ($this->getAttribute($this->getAttribute(        // line 1021
($context["settings"] ?? null), "members", array()), "custeom-text-if-no-users-found", array(), "array") == "false"))), "custeom-text-if-no-users-found");
        // line 1024
        echo "
\t\t\t\t\t -->
...
($context["settings"] ?? null), "auth", array()), "search-profiles-per-page", array(), "array"), "search-profiles-per-page");
        // line 1032
        echo "
...
($context["settings"] ?? null), "auth", array()), "search-profiles-per-page-mobile", array(), "array"), "search-profiles-per-page-mobile");
        // line 1038
        echo "
...
($context["settings"] ?? null), "auth", array()), "maximum-profiles-number", array(), "array"), "maximum-profiles-number");
        // line 1044
        echo " -->
...
($context["buttonName"] ?? null))), array(0 => array("name" => (((((            // line 1248
($context["settProp1"] ?? null) . "[") . ($context["settProp2"] ?? null)) . "][") . ($context["itemCode"] ?? null)) . "-text-font-size-check]"), "value" => 1, "checked" => ((($this->getAttribute($this->getAttribute($this->getAttribute(            // line 1250
($context["settings"] ?? null), ($context["settProp1"] ?? null), array(), "array"), ($context["settProp2"] ?? null), array(), "array"), (($context["itemCode"] ?? null) . "-text-font-size-check"), array(), "array") == 1)) ? (1) : (null)), "attributes" => (("id=\"" .             // line 1251
($context["itemCode"] ?? null)) . "-text-font-size-check\" class=\"mbs-checkbox-for-enable\""))), (            // line 1253
$context["options"]->getinput("number", (((((            // line 1255
($context["settProp1"] ?? null) . "[") . ($context["settProp2"] ?? null)) . "][") . ($context["itemCode"] ?? null)) . "-text-font-size-number]"), _twig_default_filter((($this->getAttribute($this->getAttribute($this->getAttribute(            // line 1256
...
($context["itemCode"] ?? null) . "-text-font-size-number"), "class" => "mbs-number-units-width", "pattern" => "[0-9]")) .             // line 1258
$context["options"]->getselectInput2(            // line 1259
($context["fontsSizeUnits"] ?? null), _twig_default_filter((($this->getAttribute($this->getAttribute($this->getAttribute(            // line 1260
...
($context["itemCode"] ?? null) . "-text-font-unit-select"), "class" => "mbs-selector-unit-width sc-input", "name" => (((((            // line 1264
($context["settProp1"] ?? null) . "[") . ($context["settProp2"] ?? null)) . "][") . ($context["itemCode"] ?? null)) . "-text-font-unit-select]")))));
            // line 1267
            echo "
";
        } catch (Exception $e) {
...
($context["buttonName"] ?? null))), array(0 => array("name" => (((((            // line 1275
($context["settProp1"] ?? null) . "[") . ($context["settProp2"] ?? null)) . "][") . ($context["itemCode"] ?? null)) . "-text-font-family-check]"), "value" => 1, "checked" => ((($this->getAttribute($this->getAttribute($this->getAttribute(            // line 1277
($context["settings"] ?? null), ($context["settProp1"] ?? null), array(), "array"), ($context["settProp2"] ?? null), array(), "array"), (($context["itemCode"] ?? null) . "-text-font-family-check"), array(), "array") == 1)) ? (1) : (null)), "attributes" => (("id=\"" .             // line 1278
($context["itemCode"] ?? null)) . "-text-font-family-check\" class=\"mbs-checkbox-for-enable\""))),             // line 1280
$context["options"]->getselectInput2(            // line 1281
($context["fontsList"] ?? null), _twig_default_filter((($this->getAttribute($this->getAttribute($this->getAttribute(            // line 1282
...
($context["itemCode"] ?? null) . "-text-font-family-select"), "class" => "mbs-cwib-selector-width sc-input", "name" => (((((            // line 1286
($context["settProp1"] ?? null) . "[") . ($context["settProp2"] ?? null)) . "][") . ($context["itemCode"] ?? null)) . "-text-font-family-select]")), 1));
            // line 1290
            echo "
";
        } catch (Exception $e) {
...
($context["buttonName"] ?? null))), array(0 => array("name" => (((((            // line 1298
($context["settProp1"] ?? null) . "[") . ($context["settProp2"] ?? null)) . "][") . ($context["itemCode"] ?? null)) . "-text-color-check]"), "value" => 1, "checked" => (((($this->getAttribute($this->getAttribute($this->getAttribute(            // line 1300
($context["settings"] ?? null), ($context["settProp1"] ?? null), array(), "array"), ($context["settProp2"] ?? null), array(), "array"), (($context["itemCode"] ?? null) . "-text-color-check"), array(), "array") == 1) || (($context["defaultColor"] ?? null) != null))) ? (1) : (null)), "attributes" => (("id=\"" .             // line 1301
($context["itemCode"] ?? null)) . "-text-color-check\" class=\"mbs-checkbox-for-enable\""))),             // line 1303
$context["options"]->getcolorInput2(array("id" => (            // line 1304
($context["itemCode"] ?? null) . "-text-color-input"), "class" => "mbs-cwib-selector-width sc-input", "name" => (((((            // line 1306
($context["settProp1"] ?? null) . "[") . ($context["settProp2"] ?? null)) . "][") . ($context["itemCode"] ?? null)) . "-text-color-input]"), "value" => _twig_default_filter((($this->getAttribute($this->getAttribute($this->getAttribute(            // line 1307
($context["settings"] ?? null), ($context["settProp1"] ?? null), array(), "array", false, true), ($context["settProp2"] ?? null), array(), "array", false, true), (($context["itemCode"] ?? null) . "-text-color-input"), array(), "array", true, true)) ? (_twig_default_filter($this->getAttribute($this->getAttribute($this->getAttribute(($context["settings"] ?? null), ($context["settProp1"] ?? null), array(), "array", false, true), ($context["settProp2"] ?? null), array(), "array", false, true), (($context["itemCode"] ?? null) . "-text-color-input"), array(), "array"), ($context["defaultColor"] ?? null))) : (($context["defaultColor"] ?? null))), "rgba(0, 0, 0, 1)"))));
            // line 1309
            echo "
";
        } catch (Exception $e) {
    ...
    {
        return new Twig_Source("", "@design/backend/index.twig", "/Users/shingkeelau/Public/web/wp-content/plugins/membership-by-supsystic/src/Membership/Design/views/backend/index.twig");
    }
}
