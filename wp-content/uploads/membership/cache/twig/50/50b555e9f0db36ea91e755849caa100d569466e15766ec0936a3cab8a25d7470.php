...
class __TwigTemplate_6703c25c656ab1cdb40e11d6dc31f2bc9f7afaef6d1432bf1ae6e9fe727f6842 extends Twig_Template
{
...
\t\t\t";
        // line 7
        $context["adminAreaMenus"] = $this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "getAdminAreaMenus", array(), "method");
        // line 8
        echo "\t\t\t";
        if ((isset($context["adminAreaMenus"]) ? $context["adminAreaMenus"] : null)) {
            // line 9
            echo "\t\t\t\t";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable((isset($context["adminAreaMenus"]) ? $context["adminAreaMenus"] : null));
            foreach ($context['_seq'] as $context["_key"] => $context["menu"]) {
                // line 10
                echo "\t\t\t\t\t";
                $context["active"] = (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == $this->getAttribute($context["menu"], "module", array())) || ($this->getAttribute($context["menu"], "is_main", array()) && (null === $this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()))));
                // line 11
                echo "\t\t\t\t\t";
                if ((($this->getAttribute($context["menu"], "action", array()) && ($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "action", array()) != $this->getAttribute($context["menu"], "action", array()))) || ($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "action", array()) && ($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "action", array()) != $this->getAttribute($context["menu"], "action", array()))))) {
                    // line 12
                    echo "\t\t\t\t\t\t";
                ...
                // line 14
                echo "\t\t\t\t\t";
                $context["menuUrl"] = (($this->getAttribute($context["menu"], "action", array())) ? ($this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "generateUrl", array(0 => $this->getAttribute($context["menu"], "module", array()), 1 => $this->getAttribute($context["menu"], "action", array())), "method")) : ($this->getAttribute((isset($context["environment"]) ? $context["environment"] : null), "generateUrl", array(0 => $this->getAttribute($context["menu"], "module", array())), "method")));
                // line 15
...
\t\t\t\t\t\t<a href=\"";
                // line 20
                echo twig_escape_filter($this->env, (isset($context["menuUrl"]) ? $context["menuUrl"] : null), "html", null, true);
                echo "\">
\t\t\t\t\t\t\t";
                // line 21
...
\t\t\t\t\t";
                // line 40
                if (((isset($context["active"]) ? $context["active"] : null) && twig_test_empty($this->getAttribute($context["menu"], "is_main", array())))) {
                    // line 41
...
\t\t\t\t";
            // line 64
            if ((($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == "membership") || (null === $this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array())))) {
                // line 65
                echo "\t\t\t\t\tactive
\t\t\t\t";
            }
...
\t\t\t\t";
            // line 76
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == "users")) {
                // line 77
                echo "\t\t\t\t\tactive
\t\t\t\t";
            }
...
\t\t\t\t";
            // line 91
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == "roles")) {
                // line 92
                echo "\t\t\t\t\tactive
\t\t\t\t";
            }
...
\t\t\t\t";
            // line 106
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == "groups")) {
                // line 107
                echo "\t\t\t\t\tactive
\t\t\t\t";
            }
...
\t\t\t\t";
            // line 119
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == "messages")) {
                // line 120
                echo "\t\t\t\t\tactive
\t\t\t\t";
            }
...
\t\t\t\t";
            // line 132
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == "design")) {
                // line 133
                echo "\t\t\t\t\tactive
\t\t\t\t";
            }
...
\t\t\t\t";
            // line 145
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "module", array()) == "reports")) {
                // line 146
                echo "\t\t\t\t\tactive
\t\t\t\t";
            }
...
\t</div>
    ...
    {
        return new Twig_Source("", "@base/layouts/backend.twig", "/Users/shingkeelau/web/wp-content/plugins/membership-by-supsystic/src/Membership/Base/views/layouts/backend.twig");
    }
}
