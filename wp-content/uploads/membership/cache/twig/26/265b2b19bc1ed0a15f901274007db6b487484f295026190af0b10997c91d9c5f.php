...
class __TwigTemplate_f681904c33ea796b791db18acaaf99078758b05e066548968e48e936fdbaa29b extends Twig_Template
{
...
\t\t\t\t\t\t<input class=\"sc-input search-users-input\" type=\"text\" placeholder=\"";
        ...
        echo "\" value=\"";
        echo twig_escape_filter($this->env, $this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "search", array()), "html", null, true);
        echo "\">
\t\t\t\t\t</div>
\t\t\t\t\t<div class=\"col-md-4\">
...
\t\t\t\t\t\t";
        // line 55
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable((isset($context["userStatusesList"]) ? $context["userStatusesList"] : null));
...
\t\t\t";
        ...
        if ((isset($context["users"]) ? $context["users"] : null)) {
            // line 68
            echo "\t\t\t\t";
            $context["requestQuery"] = $this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "all", array());
            // line 69
            echo "\t\t\t\t
...
\t\t\t\t\t\t\t\t";
            // line 83
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "sort", array()) == "user_registered")) {
                // line 84
                echo "\t\t\t\t\t\t\t\t\t";
                if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "order", array()) == "asc")) {
                    // line 85
                    echo "\t\t\t\t\t\t\t\t\t\t";
                    $context["icon"] = "<i class=\"fa fa-sort-asc\" aria-hidden=\"true\"></i>";
                    // line 86
                    echo "\t\t\t\t\t\t\t\t\t\t";
                    $context["requestQuery"] = twig_array_merge((isset($context["requestQuery"]) ? $context["requestQuery"] : null), array("sort" => "user_registered", "order" => "desc"));
                    // line 87
                    echo "\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 88
                    ...
                    // line 89
                    echo "\t\t\t\t\t\t\t\t\t\t";
                    $context["requestQuery"] = twig_array_merge((isset($context["requestQuery"]) ? $context["requestQuery"] : null), array("sort" => "user_registered", "order" => "asc"));
                    // line 90
                    echo "\t\t\t\t\t\t\t\t\t";
                }
                // line 91
                ...
                // line 93
                echo "\t\t\t\t\t\t\t\t\t";
                if ($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "sort", array())) {
                    // line 94
                    echo "\t\t\t\t\t\t\t\t\t\t";
            ...
            // line 99
            echo "\t\t\t\t\t\t\t\t<a href=\"";
            echo twig_escape_filter($this->env, $this->env->getExtension('Membership_Base_Twig')->dashboardUrl("roles", null, (isset($context["requestQuery"]) ? $context["requestQuery"] : null)), "html", null, true);
            echo "#users\">
\t\t\t\t\t\t\t\t\t<span>";
            // line 100
...
\t\t\t\t\t\t\t\t";
            // line 105
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "sort", array()) == "role")) {
                // line 106
                echo "\t\t\t\t\t\t\t\t\t";
                if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "order", array()) == "asc")) {
                    // line 107
                    ...
                    // line 108
                    echo "\t\t\t\t\t\t\t\t\t\t";
                    $context["requestQuery"] = twig_array_merge((isset($context["requestQuery"]) ? $context["requestQuery"] : null), array("sort" => "role", "order" => "desc"));
                    // line 109
                    echo "\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 110
                    ...
                    // line 111
                    echo "\t\t\t\t\t\t\t\t\t\t";
                    $context["requestQuery"] = twig_array_merge((isset($context["requestQuery"]) ? $context["requestQuery"] : null), array("sort" => "role", "order" => "asc"));
                    // line 112
                    echo "\t\t\t\t\t\t\t\t\t";
                }
                // line 113
...
\t\t\t\t\t\t\t\t";
            // line 122
            if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "sort", array()) == "status")) {
                // line 123
                echo "\t\t\t\t\t\t\t\t\t";
                if (($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "order", array()) == "asc")) {
                    // line 124
                    ...
                    // line 125
                    echo "\t\t\t\t\t\t\t\t\t\t";
                    $context["requestQuery"] = twig_array_merge((isset($context["requestQuery"]) ? $context["requestQuery"] : null), array("sort" => "status", "order" => "desc"));
                    // line 126
                    echo "\t\t\t\t\t\t\t\t\t";
                } else {
                    // line 127
                    ...
                    // line 128
                    echo "\t\t\t\t\t\t\t\t\t\t";
                    $context["requestQuery"] = twig_array_merge((isset($context["requestQuery"]) ? $context["requestQuery"] : null), array("sort" => "status", "order" => "asc"));
                    // line 129
                    echo "\t\t\t\t\t\t\t\t\t";
                }
                // line 130
...
(isset($context["request"]) ? $context["request"] : null), "query", array()), "p", array())) ? ($this->getAttribute($this->getAttribute((isset($context["request"]) ? $context["request"] : null), "query", array()), "p", array())) : ("1")), "totalPages" =>             // line 182
(isset($context["totalPaginationPages"]) ? $context["totalPaginationPages"] : null), "hash" => "users"), array("search" => $this->getAttribute($this->getAttribute(            // line 186
(isset($context["request"]) ? $context["request"] : null), "query", array()), "search", array())));
            // line 188
            echo "
\t\t\t\t\t</div>
...
\t\t\t\t\t\t<span>";
            // line 191
            echo twig_escape_filter($this->env, sprintf(call_user_func_array($this->env->getFunction('translate')->getCallable(), array("Found %d users")), (isset($context["totalUsers"]) ? $context["totalUsers"] : null)), "html", null, true);
            echo "</span>
\t\t\t\t\t</div>
\t\t\t\t</div>
\t\t\t";
...
";
    ...
    {
        return new Twig_Source("", "@users/backend/users-list.twig", "/Users/shingkeelau/web/wp-content/plugins/membership-by-supsystic/src/Membership/Users/views/backend/users-list.twig");
    }
}
