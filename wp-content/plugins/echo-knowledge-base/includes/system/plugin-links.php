...
function epkb_add_plugin_action_links ( $links ) {
	$my_links = array(
		...
		'Docs'      => '<a href="https://www.echoknowledgebase.com/documentation/" target="_blank">' . esc_html__( 'Docs', 'echo-knowledge-base' ) . '</a>',
		'Support'   => '<a href="https://www.echoknowledgebase.com/contact-us/?inquiry-type=technical">' . esc_html__( 'Support', 'echo-knowledge-base' ) . '</a>'
	);
...
function epkb_add_plugin_row_meta($links, $file) {
	...
	$links[] = '<a href="https://www.echoknowledgebase.com/knowledge-base-plugin-update-3-2-2/" target="_blank">' . esc_html__( "What's New", 'echo-knowledge-base' ) . '</a>';
	return $links;
}
