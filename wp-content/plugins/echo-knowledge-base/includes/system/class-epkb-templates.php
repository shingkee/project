...
class EPKB_Templates {
	...
	public static function template_loader( $template ) {
        global $eckb_kb_id, $eckb_is_kb_main_page, $epkb_kb_templates_on;
		...
		$templates_for_kb = empty($all_kb_configs[$kb_id]['templates_for_kb']) ? 'current_theme_templates' : $all_kb_configs[$kb_id]['templates_for_kb'];
