...
class EPKB_KB_Config_Page {
	...
	public function display_kb_config_page() {
		...
		if ( ! $this->can_save_config ) {
			echo '<p>Could not retrieve KB configuration.</p>';
			return;
		}
	...
	public function display_mega_menu() {
		...
		if ( $this->kb_article_page_layout != EPKB_KB_Config_Layouts::KB_ARTICLE_PAGE_NO_LAYOUT ) {
			$article_page_core_links = array('SETUP', 'ORGANIZE', 'FEATURES', 'TUNING');
		} else if ( $article_page_with_config_layout ) {
			$article_page_core_links = array('SETUP', 'FEATURES', 'ALL TEXT', 'TUNING');
		} else {
			$article_page_core_links = array('SETUP', 'FEATURES', 'TUNING');
		}
	...
	private function mega_menu_kb_templates() {
        ...
        echo '<p><a href="http://www.echoknowledgebase.com/documentation/kb-templates/" target="_blank" class="eckb-external-link">More about templates</a>';
     ...
     * @return string
     */
	public function get_article_page_styles_form() {
        ...
        <div class="epkb-config-sidebar" id="epkb-config-article-styles-sidebar">
            <div class="epkb-config-sidebar-options" id="epkb_style_sidebar_options">                <?php
	            ...
	            // these inputs
	            if ( $this->kb_main_page_layout != EPKB_KB_Config_Layouts::SIDEBAR_LAYOUT && $this->kb_article_page_layout == EPKB_KB_Config_Layouts::SIDEBAR_LAYOUT ) {
     ...
     * @return string
     */
	public function get_article_page_colors_form() {
     ...
     * @return string
     */
	public function get_article_page_text_form() {
