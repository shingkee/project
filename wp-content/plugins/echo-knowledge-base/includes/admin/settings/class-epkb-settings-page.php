...
class EPKB_Settings_Page {
	...
	private static function display_page_details() {
		...
		$debug_tab_active = isset($_REQUEST['info_tab']) && $_REQUEST['info_tab'] == 'debug';
	...
	private static function display_feedback_form( $form ) {   ?>
		...
		<div class="form_options">
            <div class="ekb-feedback-type-container">
                <h4>What best describes your inquiry?</h4>
                <a href="http://www.echoknowledgebase.com/contact-us/?inquiry-type=technical" class="ekb-feedback-btn">Technical Support<span class="icon_tools"></span></a>
                <a id="feature-request" class="ekb-feedback-btn">Feature Request<span class="icon_lightbulb_alt"></span></a>
            </div>
	...
	private static function display_debug_info( $form ) {
		...
		<div class="form_options" id="epkb_debug_info_tab_page">
			...
			<section style="padding-top: 20px;" class="save-settings">    <?php
				$button_text = ( $is_debug_on ? 'Disable' : 'Enable' ) . ' Debug';
			...
			if ( $is_debug_on ) {
				...
				<form action="<?php echo esc_url( admin_url( 'edit.php?post_type=epkb_post_type_1&page=epkb-plugin-settings' ) ); ?>" method="post" dir="ltr">
					<section style="padding-top: 20px;" class="save-settings">    <?php
