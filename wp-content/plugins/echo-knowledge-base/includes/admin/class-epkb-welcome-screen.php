...
class EPKB_Welcome_Screen {
	...
	private function show_what_is_new() {   ?>
        ...
        <div class="eckb-whats-new">
            <div class="eckb-content">
                ...
                <a class="whats-new-button" href="https://www.echoknowledgebase.com/knowledge-base-plugin-update-3-2-2/" target="_blank"> <?php esc_html_e( "Read Full Article on Our Blog", 'echo-knowledge-base' ); ?></a>
		...
		<div class="row">
			<div class="col-3">
				<h4>3.2.2, Oct 20, 2017</h4>
				<ul>
					<li>New: Option to turn off Main Page title when using KB templates</li>
					<li>New: Option to add custom margin to breadcrumbs</li>
					<li>New: Option to match style of Main page articles index and search results.</li>
					<li>: Option to add paddings and/or margins around article when using KB templates.</li>
					<li>Improved: Increase search results list to 20.</li>
					<li>Fix: Make the Last Updated On based on the site language.</li>
					<li>Fix: Do not count in KB stats trashed articles.</li>
	...
	private function display_row( $title, $content, $image_url, $button1=array(), $button2=array() ) {
		...
		<div class="row">
			...
			<div class="col-7">
                <p style="color: forestgreen; font-style: italic;">Click on any image to Zoom in</p>                <?php
	...
	private function display_help_row( $plugin_name='knowledge-base' ) {
		...
		<div class="row">
			<div class="col-3">
				<h3><span class="welcome-icon ep_font_icon_documents"></span> Documentation</h3>
				<p>Reference our Knowledge Base as it covers all the plugin features.</p>
				<a class="button primary-btn" href="https://www.echoknowledgebase.com/documentation/<?php echo $document; ?>" target="_blank">Knowledge Base</a>
			</div>
			<div class="col-3">
				<h3><span class="welcome-icon ep_font_icon_comment"></span> Still Need Some Help?</h3>
				<p>If you encounter an issue or have a question, please submit your request below.</p>
				<a class="button primary-btn" href="https://www.echoknowledgebase.com/contact-us/?inquiry-type=technical/" target="_blank">Contact Us</a>
			</div>
		</div>      <?php
	}
