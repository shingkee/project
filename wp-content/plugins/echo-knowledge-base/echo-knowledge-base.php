...
final class Echo_Knowledge_Base {
	...
	public static $needs_min_add_on_version = array( 'LAY' => '1.2.1', 'MKB' => '1.5.0', 'RTD' => '1.0.0', 'IDG' => '1.0.0' );
	...
	private function handle_ajax_requests() {
		...
		if ( $_REQUEST['action'] == 'epkb-search-kb' ) {  // user searching KB
			...
			return;
				...
				array( 'epkb_send_feedback', 'epkb_toggle_debug', 'epkb_close_welcome_header' ) ) ) {
			new EPKB_Settings_Controller();
			return;
		}
