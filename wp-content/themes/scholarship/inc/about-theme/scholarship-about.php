...
class Scholarship_About {
	...
	public static function hide_notices() {
		if ( isset( $_GET['scholarship-hide-notice'] ) && isset( $_GET['_scholarship_notice_nonce'] ) ) {
			if ( ! wp_verify_nonce( $_GET['_scholarship_notice_nonce'], 'scholarship_hide_notices_nonce' ) ) {
				wp_die( __( 'Action failed. Please refresh the page and retry.', 'scholarship' ) );
			}

			if ( ! current_user_can( 'manage_options' ) ) {
				wp_die( __( 'Cheat in &#8217; huh?', 'scholarship' ) );
			}
	...
	public function welcome_notice() {
		...
		<div id="message" class="updated scholarship-message">
			...
			<p><?php printf( esc_html__( 'Welcome! Thank you for choosing scholarship! To fully take advantage of the best our theme can offer please make sure you visit our %swelcome page%s.', 'scholarship' ), '<a href="' . esc_url( admin_url( 'themes.php?page=scholarship-welcome' ) ) . '">', '</a>' ); ?></p>
			<p class="submit">
	...
	private function intro() {
		...
		<div class="scholarship-theme-info">
				...
				<h1> <?php echo esc_html( 'About ', 'scholarship' ).' '. esc_html( $theme_name ).' '.esc_html( $scholarship_version ); ?> </h1>
			...
			<div class="changelog point-releases">
				<div class="under-the-hood two-col">
					<div class="col">
						...
						<p><a href="<?php echo admin_url( 'customize.php' ); ?>" class="button button-secondary"><?php esc_html_e( 'Customize', 'scholarship' ); ?></a></p>
					</div>
					...
					<div class="col">
						<h3> <?php echo esc_html( 'Translate', 'scholarship' ).' '.esc_html( $theme_name ); ?> </h3>
						<p><?php esc_html_e( 'Click below to translate this theme into your own language.', 'scholarship' ) ?></p>
						<p>
							<a href="<?php echo esc_url( 'https://translate.wordpress.org/projects/wp-themes/scholarship' ); ?>" class="button button-secondary" target="_blank"><?php echo esc_html( 'Translate', 'scholarship' ).' '.esc_html( $theme_name ); ?></a>
						</p>
					</div>
				</div>
			</div><!-- .point-releases -->
